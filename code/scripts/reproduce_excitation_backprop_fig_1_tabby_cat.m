...
[heatmap, res] = compute_heatmap(net, img, target_class, 'lrp_alpha_beta', norm_deg, opts);
[heatmap, res] = compute_heatmap(net, repmat(img, [1 1 1 2]), [target_class target_class], 'lrp_alpha_beta', norm_deg, opts);
